...
>
> 当前事实入口：[current-baseline.md](current-baseline.md)。本文的 Schema v12、326 单测等数值是 Phase 2 在 2026-07-23/24 的历史验收快照，不代表当前 HEAD。
...
## 1. Phase 2 启动时的历史可信基线

截至 2026-07-23，Phase 2 启动与验收时仓库已经具备：
