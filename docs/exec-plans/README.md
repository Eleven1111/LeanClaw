...
|---|---|---|---|---|
| `leanclaw-codepilot-optimization` | [CodePilot 借鉴分析与 LeanClaw 优化提升执行方案](./active/CodePilot借鉴分析与LeanClaw优化执行方案.md) | P1 / T05 | T05 本地门禁通过；远端 Required Checks 待验证 | P0 已验收；CP1 尚未验收 |
